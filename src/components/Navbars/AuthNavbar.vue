<template>
  ...
  >
    ...
    >
      ...
      >
        <router-link
          class="text-white text-lg font-bold leading-relaxed inline-block mr-4 py-2 whitespace-no-wrap uppercase"
          to="/"
        >
          <h3>
            <span>P</span><span>roduct</span>
            <span>A</span><span>uthentication</span>
            <span>Q</span><span>uick</span>
            <span>S</span><span>can</span>
          </h3>
        </router-link>
        <button
        ...
        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
          ...
          <li class="flex items-center">
            ...
            >
              ...
              >
                <button
                  class="bg-white text-gray-800 active:bg-gray-100 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-outline outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150"
                  type="button"
                >
